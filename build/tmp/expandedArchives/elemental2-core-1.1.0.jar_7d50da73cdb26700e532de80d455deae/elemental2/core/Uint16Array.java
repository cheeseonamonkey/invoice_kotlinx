...
public class Uint16Array extends TypedArray {
  ...
  public static native <S> Uint16Array from(
      Uint16Array.FromSourceUnionType source, Uint16Array.FromMapFn mapFn, S this_);
  ...
  public static final <S> Uint16Array from(
      JsArrayLike<Double> source, Uint16Array.FromMapFn mapFn, S this_) {
  ...
  @JsOverlay
  public static final <S> Uint16Array from(
      JsIterable<Double> source, Uint16Array.FromMapFn mapFn, S this_) {
    return from(Js.<Uint16Array.FromSourceUnionType>uncheckedCast(source), mapFn, this_);
  }
